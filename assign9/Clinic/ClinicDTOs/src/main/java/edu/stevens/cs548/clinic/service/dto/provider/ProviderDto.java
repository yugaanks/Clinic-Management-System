...
// Generated on: 2016.11.16 at 01:44:18 PM EDT 
//
...
@XmlType(name = "", propOrder = { "id", "npi", "name", "specialization", "treatments" })
...
public class ProviderDto {
	 ...
	 * <CODE>set</CODE> method for the treatments property.
	 * 
	 * <p>
	...
	public ProviderDto(Provider prov) {
		this.id = prov.getId();
		this.npi = prov.getNpi();
		this.name = prov.getName();
		this.specialization = prov.getSpecialization();
		this.treatments = prov.getTreatmentIds();
	}
